...
class PostOwnerAdapter(var postList : List<PostInfo>) : RecyclerView.Adapter<PostOwnerAdapter.PostOwnerViewHolder>() {
    var genericList : MutableList<PostInfo> = postList as MutableList<PostInfo>
    inner class PostOwnerViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostOwnerViewHolder {
        return PostOwnerViewHolder(
